...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    public void start(final boolean startFactory) throws MQClientException {
        switch (this.serviceState) {
            case CREATE_JUST:
                ...
                //构建 MQClientManager，MQClientInstance，MQClientAPIImpl，PullMessageService，RebalanceService，DefaultMQProducer，MQAdminImpl
                //MQClientManager静态类对象，维护了所有的MQClientInstance 信息
    ...
    /**
     * 发送消息，检查本地是否有路由信息和topic信息，没有的话先去获取
     * @param msg 消息内容
    ...
    private SendResult sendDefaultImpl(
        ...
        //访问本地的topic信息和路由信息，没有则去nameSer去拉
    ...
    /**
     * 获取topic信息和路由信息，本地没有的话去服务器（nameSer）拉
     * @param topic
     * @return
     */
    ...
    private SendResult sendKernelImpl(final Message msg,
        ...
        if (brokerAddr != null) {
            //是否使用broker vip通道。broker会开启两个端口对外服务。，居然还VIP。办卡了
